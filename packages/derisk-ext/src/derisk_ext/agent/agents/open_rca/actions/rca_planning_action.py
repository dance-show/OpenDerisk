...
from derisk.agent.core.memory.gpts.gpts_memory import GptsPlansMemory
...
class RcaPlanningAction(Action[TaskPlan]):
    """Plan action class."""
    ...
    async def run(
        ...
        try:
            ...
            task_plan: TaskPlan = self._input_convert(
                ai_message, TaskPlan
            )
