...
class IpythonAction(Action[None]):
    ...
    async def run(
        ...
        try:
            ...
            if "import matplotlib" in code_blocks or "import seaborn" in code_blocks:
            ...
            if status:
                ...
                answer = await self.summary_action(llm_client, llm_model, agent_history, code_blocks, result)
