...
class GptsMemory:
    ...
    async def append_message(self, conv_id: str, message: GptsMessage, incremental: bool = False, ):
        logger.info(f"append_message:{conv_id},{message.message_id}")
        """Append message."""
        ...
        logger.info(f"push append message:{conv_id},{message.message_id}")
